...
router.post("/insert", async (req, res) => {
    ...
    const customer = new Customer({ firstname: firstname , lastname: lastname, cusername:cusername, contact:contact, address:address, gender:gender, city:city, password:password  });
    try {
        await customer.save();
